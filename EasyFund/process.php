...
if (isset($_POST["create"])) {
    ...
    $sqlInsert = "INSERT INTO fundraising(title , description , targetAmount , accountNumber) VALUES ('$title','$description','$targetAmount', '$hashedAccountNumber')";
...
if (isset($_POST["edit"])) {
    ...
    $sqlUpdate = "UPDATE fundraising SET title = '$title', description = '$description', targetAmount = '$targetAmount' WHERE id='$id'";
